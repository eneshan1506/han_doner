    ...
    <section className="section">
      <div className="container contact-card">
        ...
        <div className="contact-grid">
          <a href={`tel:${siteConfig.contact.phone}`} className="contact-item">
            <span>Telefon</span>
            <strong>{siteConfig.contact.phone}</strong>
          </a>
          <a href={whatsappLink} className="contact-item" target="_blank" rel="noreferrer">
            <span>WhatsApp</span>
        ...
        <div className="contact-map-wrap">
          <div className="contact-address-card">
            ...
            <a href={siteConfig.location.mapsUrl} target="_blank" rel="noreferrer" className="btn btn-primary">
